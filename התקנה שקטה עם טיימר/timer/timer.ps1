Function Start-CountDownTimer {  
    ...
    while ( $i -ne $Timer.TotalSeconds) {
        ...
        Write-Verbose "If Files finished the installation, you can close this window."
       
        Write-Progress -Activity "Time Remaining: $TimeDifference, Please wait..." -Status "Timer Progress $Percentage%" -PercentComplete $Percentage
